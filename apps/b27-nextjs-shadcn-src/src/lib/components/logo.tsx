...
export function Logo({ color = "currentColor", className }: LogoProps) {
	return (
		<svg
			viewBox="0 0 8201.7441 7351.1607"
			width="100%"
			...
			style={{ color }}
			xmlns="http://www.w3.org/2000/svg"
			// include any other props like `fill`, etc.
		>
			<defs>
				<clipPath clipPathUnits="userSpaceOnUse" id="clipPath3474">
					<path d="M 0,576 H 576 V 0 H 0 Z" id="path3476" />
...
export function GradientLogo({
	gradientFrom = "#6366f1", // Tailwind `indigo-500`
	gradientTo = "#8b5cf6", // Tailwind `violet-500`
	className,
}: GradientLogoProps) {
	return (
		<svg
